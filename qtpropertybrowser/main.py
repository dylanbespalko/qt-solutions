...
if __name__ == "__main__":
    ...
    for count in range(1):
        ...
        property_ = manager_map['int'].addProperty("int")
        property_.propertyManager().setValue(property_, 3)
        property_.propertyManager().setMinimum(property_, 0)
        property_.propertyManager().setMaximum(property_, 5)
        property_.propertyManager().setValue(property_, 7)
        ...
        property_ = manager_map['float'].addProperty("float")
        ...
        property_ = manager_map['size'].addProperty("size")
