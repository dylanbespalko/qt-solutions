...
QWidget * QtCursorEditorFactoryWrapper::createAttributeEditor(QtCursorPropertyManager * manager, QtProperty * property, QWidget * parent, Attribute attribute)
{
    Shiboken::GilState gil;
    if (PyErr_Occurred())
        return nullptr;
...
static PyObject* Sbk_QtCursorEditorFactoryFunc_createAttributeEditor(PyObject* self, PyObject* args)
{
    ...
    // Overloaded function decisor
    // 0: QtCursorEditorFactory::createAttributeEditor(QtCursorPropertyManager*,QtProperty*,QWidget*,Attribute)
    if (numArgs == 4
        ...
        overloadId = 0; // createAttributeEditor(QtCursorPropertyManager*,QtProperty*,QWidget*,Attribute)
    }
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            // createAttributeEditor(QtCursorPropertyManager*,QtProperty*,QWidget*,Attribute)
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
...
const char QtCursorEditorFactory_SignaturesString[] = ""
    "qtpropertybrowser.QtCursorEditorFactory(parent:PySide2.QtCore.QObject=0)\n"
    "qtpropertybrowser.QtCursorEditorFactory.connectPropertyManager(manager:qtpropertybrowser.QtCursorPropertyManager)\n"
    "qtpropertybrowser.QtCursorEditorFactory.createAttributeEditor(manager:qtpropertybrowser.QtCursorPropertyManager,property:qtpropertybrowser.QtProperty,parent:PySide2.QtWidgets.QWidget,attribute:qtpropertybrowser.Attribute)->PySide2.QtWidgets.QWidget\n"
