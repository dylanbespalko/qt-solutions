...
QWidget * QtScrollBarFactoryWrapper::createAttributeEditor(QtIntPropertyManager * manager, QtProperty * property, QWidget * parent, Attribute attribute)
{
    Shiboken::GilState gil;
    if (PyErr_Occurred())
        return nullptr;
...
static PyObject* Sbk_QtScrollBarFactoryFunc_createAttributeEditor(PyObject* self, PyObject* args)
{
    ...
    // Overloaded function decisor
    // 0: QtScrollBarFactory::createAttributeEditor(QtIntPropertyManager*,QtProperty*,QWidget*,Attribute)
    if (numArgs == 4
...
const char QtScrollBarFactory_SignaturesString[] = ""
    "qtpropertybrowser.QtScrollBarFactory(parent:PySide2.QtCore.QObject=0)\n"
    "qtpropertybrowser.QtScrollBarFactory.connectPropertyManager(manager:qtpropertybrowser.QtIntPropertyManager)\n"
    "qtpropertybrowser.QtScrollBarFactory.createAttributeEditor(manager:qtpropertybrowser.QtIntPropertyManager,property:qtpropertybrowser.QtProperty,parent:PySide2.QtWidgets.QWidget,attribute:qtpropertybrowser.Attribute)->PySide2.QtWidgets.QWidget\n"
