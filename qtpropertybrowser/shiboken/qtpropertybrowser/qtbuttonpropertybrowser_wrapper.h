...
{
public:
    QtButtonPropertyBrowserWrapper(QWidget * parent = 0);
    ...
    inline QWidget * createAttributeEditor_protected(QtProperty * property, QWidget * parent, Attribute attribute) { return QtButtonPropertyBrowser::createAttributeEditor(property, parent, Attribute(attribute)); }
