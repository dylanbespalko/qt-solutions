...
bool QtRectPropertyManagerWrapper::check(const QtProperty * property) const
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtRectPropertyManager.check", "bool", Py_TYPE(pyResult)->tp_name);
        return false;
    }
    bool cppResult;
...
QIcon QtRectPropertyManagerWrapper::checkIcon(const QtProperty * property) const
{
    ...
    if (pyOverride.isNull()) {
        gil.release();
        return this->::QtRectPropertyManager::checkIcon(property);
    }
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtRectPropertyManager.checkIcon", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QIcon >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return {};
    }
    ::QIcon cppResult;
    pythonToCpp(pyResult, &cppResult);
...
QtProperty * QtRectPropertyManagerWrapper::createProperty()
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtRectPropertyManager.createProperty", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QtProperty >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return nullptr;
    }
...
QString QtRectPropertyManagerWrapper::displayText(const QtProperty * property) const
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtRectPropertyManager.displayText", "QString", Py_TYPE(pyResult)->tp_name);
        return ::QString();
    }
    ::QString cppResult;
    pythonToCpp(pyResult, &cppResult);
...
QLineEdit::EchoMode QtRectPropertyManagerWrapper::echoMode(const QtProperty * arg__1) const
{
    Shiboken::GilState gil;
    if (PyErr_Occurred())
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtRectPropertyManager.echoMode", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QLineEdit::EchoMode >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return QLineEdit::Normal;
    }
...
bool QtRectPropertyManagerWrapper::event(QEvent * event)
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(Shiboken::Conversions::PrimitiveTypeConverter<bool>(), pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtRectPropertyManager.event", "bool", Py_TYPE(pyResult)->tp_name);
        return false;
    }
    bool cppResult;
    pythonToCpp(pyResult, &cppResult);
...
bool QtRectPropertyManagerWrapper::eventFilter(QObject * watched, QEvent * event)
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(Shiboken::Conversions::PrimitiveTypeConverter<bool>(), pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtRectPropertyManager.eventFilter", "bool", Py_TYPE(pyResult)->tp_name);
        return false;
    }
    bool cppResult;
    pythonToCpp(pyResult, &cppResult);
...
QBrush QtRectPropertyManagerWrapper::foreground(const QtProperty * property) const
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtRectPropertyManager.foreground", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QBrush >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return {};
    }
    ::QBrush cppResult;
    pythonToCpp(pyResult, &cppResult);
...
QString QtRectPropertyManagerWrapper::formatText(const QtProperty * property) const
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtRectPropertyManager.formatText", "QString", Py_TYPE(pyResult)->tp_name);
        return ::QString();
    }
    ::QString cppResult;
    pythonToCpp(pyResult, &cppResult);
...
bool QtRectPropertyManagerWrapper::hasValue(const QtProperty * property) const
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(Shiboken::Conversions::PrimitiveTypeConverter<bool>(), pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtRectPropertyManager.hasValue", "bool", Py_TYPE(pyResult)->tp_name);
        return false;
    }
    bool cppResult;
    pythonToCpp(pyResult, &cppResult);
...
void QtRectPropertyManagerWrapper::initializeProperty(QtProperty * property)
{
    ...
    if (pyOverride.isNull()) {
        gil.release();
        this->::QtRectPropertyManager::initializeProperty(property);
        return;
    }
...
bool QtRectPropertyManagerWrapper::isReadOnly(const QtProperty * arg__1) const
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(Shiboken::Conversions::PrimitiveTypeConverter<bool>(), pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtRectPropertyManager.isReadOnly", "bool", Py_TYPE(pyResult)->tp_name);
        return false;
    }
    bool cppResult;
    pythonToCpp(pyResult, &cppResult);
...
QString QtRectPropertyManagerWrapper::maximumText(const QtProperty * property) const
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtRectPropertyManager.maximumText", "QString", Py_TYPE(pyResult)->tp_name);
        return ::QString();
    }
    ::QString cppResult;
    pythonToCpp(pyResult, &cppResult);
...
QString QtRectPropertyManagerWrapper::minimumText(const QtProperty * property) const
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtRectPropertyManager.minimumText", "QString", Py_TYPE(pyResult)->tp_name);
        return ::QString();
    }
    ::QString cppResult;
    pythonToCpp(pyResult, &cppResult);
...
QString QtRectPropertyManagerWrapper::pkAvgText(const QtProperty * property) const
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtRectPropertyManager.pkAvgText", "QString", Py_TYPE(pyResult)->tp_name);
        return ::QString();
    }
    ::QString cppResult;
    pythonToCpp(pyResult, &cppResult);
...
void QtRectPropertyManagerWrapper::uninitializeProperty(QtProperty * property)
{
    ...
    if (pyOverride.isNull()) {
        gil.release();
        this->::QtRectPropertyManager::uninitializeProperty(property);
        return;
    }
...
QString QtRectPropertyManagerWrapper::unitText(const QtProperty * property) const
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtRectPropertyManager.unitText", "QString", Py_TYPE(pyResult)->tp_name);
        return ::QString();
    }
    ::QString cppResult;
    pythonToCpp(pyResult, &cppResult);
...
QIcon QtRectPropertyManagerWrapper::valueIcon(const QtProperty * property) const
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppValueConvertible(reinterpret_cast<SbkObjectType *>(SbkPySide2_QtGuiTypes[SBK_QICON_IDX]), pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtRectPropertyManager.valueIcon", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QIcon >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return {};
    }
    ::QIcon cppResult;
    pythonToCpp(pyResult, &cppResult);
...
QString QtRectPropertyManagerWrapper::valueText(const QtProperty * property) const
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtRectPropertyManager.valueText", "QString", Py_TYPE(pyResult)->tp_name);
        return ::QString();
    }
    ::QString cppResult;
    pythonToCpp(pyResult, &cppResult);
...
Sbk_QtRectPropertyManager_Init(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    ::QtRectPropertyManagerWrapper* cptr = 0;
    int overloadId = -1;
    ...
    // 0: QtRectPropertyManager(QObject*)
    if (numArgs == 0) {
    ...
    // Call function/method
    {
        if (kwds) {
            ...
            if (value && pyArgs[0]) {
                PyErr_SetString(PyExc_TypeError, "qtpropertybrowser.QtRectPropertyManager(): got multiple values for keyword argument 'parent'.");
                return -1;
            } else if (value) {
                pyArgs[0] = value;
    ...
    Sbk_QtRectPropertyManager_Init_TypeError:
        ...
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtRectPropertyManager", overloads);
        return -1;
}

static PyObject* Sbk_QtRectPropertyManagerFunc_check(PyObject* self, PyObject* pyArg)
{
    QtRectPropertyManagerWrapper* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
        return 0;
    cppSelf = (QtRectPropertyManagerWrapper*)reinterpret_cast< ::QtRectPropertyManager *>(Shiboken::Conversions::cppPointer(SbkqtpropertybrowserTypes[SBK_QTRECTPROPERTYMANAGER_IDX], reinterpret_cast<SbkObject *>(self)));
    PyObject* pyResult = 0;
    int overloadId = -1;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            bool cppResult = Shiboken::Object::hasCppWrapper(reinterpret_cast<SbkObject*>(self)) ? const_cast<const ::QtRectPropertyManagerWrapper*>(cppSelf)->::QtRectPropertyManager::check(cppArg0) : const_cast<const ::QtRectPropertyManagerWrapper*>(cppSelf)->check(cppArg0);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
    ...
    Sbk_QtRectPropertyManagerFunc_check_TypeError:
        ...
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtRectPropertyManager.check", overloads);
        return 0;
}
...
static PyObject* Sbk_QtRectPropertyManagerFunc_checkIcon(PyObject* self, PyObject* pyArg)
{
    ...
    // Function signature not found.
    if (overloadId == -1) goto Sbk_QtRectPropertyManagerFunc_checkIcon_TypeError;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            QIcon cppResult = ((::QtRectPropertyManagerWrapper*) cppSelf)->QtRectPropertyManagerWrapper::checkIcon_protected(cppArg0);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
    ...
    Sbk_QtRectPropertyManagerFunc_checkIcon_TypeError:
        const char* overloads[] = {"qtpropertybrowser.QtProperty", 0};
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtRectPropertyManager.checkIcon", overloads);
        return 0;
}
...
static PyObject* Sbk_QtRectPropertyManagerFunc_constraint(PyObject* self, PyObject* pyArg)
{
    ...
    Sbk_QtRectPropertyManagerFunc_constraint_TypeError:
        const char* overloads[] = {"qtpropertybrowser.QtProperty", 0};
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtRectPropertyManager.constraint", overloads);
        return 0;
}
...
static PyObject* Sbk_QtRectPropertyManagerFunc_initializeProperty(PyObject* self, PyObject* pyArg)
{
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            ((::QtRectPropertyManagerWrapper*) cppSelf)->QtRectPropertyManagerWrapper::initializeProperty_protected(cppArg0);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
        }
    }
    ...
    Sbk_QtRectPropertyManagerFunc_initializeProperty_TypeError:
        const char* overloads[] = {"qtpropertybrowser.QtProperty", 0};
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtRectPropertyManager.initializeProperty", overloads);
        return 0;
}
...
static PyObject* Sbk_QtRectPropertyManagerFunc_setCheck(PyObject* self, PyObject* args)
{
    ...
    Sbk_QtRectPropertyManagerFunc_setCheck_TypeError:
        ...
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtRectPropertyManager.setCheck", overloads);
        return 0;
}
...
static PyObject* Sbk_QtRectPropertyManagerFunc_setConstraint(PyObject* self, PyObject* args)
{
    ...
    // Overloaded function decisor
    // 0: setConstraint(QtProperty*,QRect)
    if (numArgs == 2
        && (pythonToCpp[0] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTPROPERTY_IDX]), (pyArgs[0])))
    ...
    Sbk_QtRectPropertyManagerFunc_setConstraint_TypeError:
        const char* overloads[] = {"qtpropertybrowser.QtProperty, PySide2.QtCore.QRect", 0};
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtRectPropertyManager.setConstraint", overloads);
        return 0;
}
...
static PyObject* Sbk_QtRectPropertyManagerFunc_setValue(PyObject* self, PyObject* args)
{
    ...
    Sbk_QtRectPropertyManagerFunc_setValue_TypeError:
        const char* overloads[] = {"qtpropertybrowser.QtProperty, PySide2.QtCore.QRect", 0};
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtRectPropertyManager.setValue", overloads);
        return 0;
}
...
static PyObject* Sbk_QtRectPropertyManagerFunc_uninitializeProperty(PyObject* self, PyObject* pyArg)
{
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            ((::QtRectPropertyManagerWrapper*) cppSelf)->QtRectPropertyManagerWrapper::uninitializeProperty_protected(cppArg0);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
        }
    }
    ...
    Sbk_QtRectPropertyManagerFunc_uninitializeProperty_TypeError:
        const char* overloads[] = {"qtpropertybrowser.QtProperty", 0};
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtRectPropertyManager.uninitializeProperty", overloads);
        return 0;
}
...
static PyObject* Sbk_QtRectPropertyManagerFunc_value(PyObject* self, PyObject* pyArg)
{
    ...
    Sbk_QtRectPropertyManagerFunc_value_TypeError:
        const char* overloads[] = {"qtpropertybrowser.QtProperty", 0};
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtRectPropertyManager.value", overloads);
        return 0;
}
...
static PyObject* Sbk_QtRectPropertyManagerFunc_valueText(PyObject* self, PyObject* pyArg)
{
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            QString cppResult = ((::QtRectPropertyManagerWrapper*) cppSelf)->QtRectPropertyManagerWrapper::valueText_protected(cppArg0);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
    ...
    Sbk_QtRectPropertyManagerFunc_valueText_TypeError:
        const char* overloads[] = {"qtpropertybrowser.QtProperty", 0};
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtRectPropertyManager.valueText", overloads);
        return 0;
}
...
static PyMethodDef Sbk_QtRectPropertyManager_methods[] = {
    ...
    {"uninitializeProperty", (PyCFunction)Sbk_QtRectPropertyManagerFunc_uninitializeProperty, METH_O},
    {"value", (PyCFunction)Sbk_QtRectPropertyManagerFunc_value, METH_O},
    {"valueText", (PyCFunction)Sbk_QtRectPropertyManagerFunc_valueText, METH_O},
...
// Class Definition -----------------------------------------------
extern "C" {
static SbkObjectType *_Sbk_QtRectPropertyManager_Type = nullptr;
static SbkObjectType *Sbk_QtRectPropertyManager_TypeF(void)
{
...
static PyType_Slot Sbk_QtRectPropertyManager_slots[] = {
    ...
    {Py_tp_traverse,    (void *)Sbk_QtRectPropertyManager_traverse},
    {Py_tp_clear,       (void *)Sbk_QtRectPropertyManager_clear},
    {Py_tp_richcompare, (void *)0},
    {Py_tp_iter,        (void *)0},
    {Py_tp_iternext,    (void *)0},
    {Py_tp_methods,     (void *)Sbk_QtRectPropertyManager_methods},
    {Py_tp_getset,      (void *)0},
    {Py_tp_init,        (void *)Sbk_QtRectPropertyManager_Init},
...
static void* Sbk_QtRectPropertyManager_typeDiscovery(void* cptr, SbkObjectType* instanceType)
{
...
static PythonToCppFunc is_QtRectPropertyManager_PythonToCpp_QtRectPropertyManager_PTR_Convertible(PyObject* pyIn) {
    ...
    if (PyObject_TypeCheck(pyIn, (PyTypeObject*)Sbk_QtRectPropertyManager_TypeF()))
...
static PyObject* QtRectPropertyManager_PTR_CppToPython_QtRectPropertyManager(const void* cppIn) {
    return PySide::getWrapperForQObject((::QtRectPropertyManager*)cppIn, Sbk_QtRectPropertyManager_TypeF());
...
const char QtRectPropertyManager_SignaturesString[] = ""
    ...
    "qtpropertybrowser.QtRectPropertyManager.uninitializeProperty(property:qtpropertybrowser.QtProperty)\n"
    "qtpropertybrowser.QtRectPropertyManager.value(property:qtpropertybrowser.QtProperty)->PySide2.QtCore.QRect\n"
    "qtpropertybrowser.QtRectPropertyManager.valueText(property:qtpropertybrowser.QtProperty)->QString\n"
;
...
void init_QtRectPropertyManager(PyObject* module)
{
    _Sbk_QtRectPropertyManager_Type = Shiboken::ObjectType::introduceWrapperType(
        ...
        QtRectPropertyManager_SignaturesString,
    ...
    SbkqtpropertybrowserTypes[SBK_QTRECTPROPERTYMANAGER_IDX]
        = reinterpret_cast<PyTypeObject*>(Sbk_QtRectPropertyManager_TypeF());

    // Register Converter
    SbkConverter* converter = Shiboken::Conversions::createConverter(Sbk_QtRectPropertyManager_TypeF(),
    ...
    PySide::Signal::registerSignals(Sbk_QtRectPropertyManager_TypeF(), &::QtRectPropertyManager::staticMetaObject);

    QtRectPropertyManagerWrapper::pysideInitQtMetaTypes();
    Shiboken::ObjectType::setSubTypeInitHook(Sbk_QtRectPropertyManager_TypeF(), &PySide::initQObjectSubType);
    PySide::initDynamicMetaObject(Sbk_QtRectPropertyManager_TypeF(), &::QtRectPropertyManager::staticMetaObject, sizeof(::QtRectPropertyManager));
}
