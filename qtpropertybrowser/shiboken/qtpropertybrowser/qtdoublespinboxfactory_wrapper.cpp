...
QWidget * QtDoubleSpinBoxFactoryWrapper::createAttributeEditor(QtDoublePropertyManager * manager, QtProperty * property, QWidget * parent, Attribute attribute)
{
    Shiboken::GilState gil;
    if (PyErr_Occurred())
        return nullptr;
...
static PyObject* Sbk_QtDoubleSpinBoxFactoryFunc_createAttributeEditor(PyObject* self, PyObject* args)
{
    ...
    // Overloaded function decisor
    // 0: QtDoubleSpinBoxFactory::createAttributeEditor(QtDoublePropertyManager*,QtProperty*,QWidget*,Attribute)
    if (numArgs == 4
        ...
        overloadId = 0; // createAttributeEditor(QtDoublePropertyManager*,QtProperty*,QWidget*,Attribute)
    }
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            // createAttributeEditor(QtDoublePropertyManager*,QtProperty*,QWidget*,Attribute)
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
...
const char QtDoubleSpinBoxFactory_SignaturesString[] = ""
    "qtpropertybrowser.QtDoubleSpinBoxFactory(parent:PySide2.QtCore.QObject=0)\n"
    "qtpropertybrowser.QtDoubleSpinBoxFactory.connectPropertyManager(manager:qtpropertybrowser.QtDoublePropertyManager)\n"
    "qtpropertybrowser.QtDoubleSpinBoxFactory.createAttributeEditor(manager:qtpropertybrowser.QtDoublePropertyManager,property:qtpropertybrowser.QtProperty,parent:PySide2.QtWidgets.QWidget,attribute:qtpropertybrowser.Attribute)->PySide2.QtWidgets.QWidget\n"
