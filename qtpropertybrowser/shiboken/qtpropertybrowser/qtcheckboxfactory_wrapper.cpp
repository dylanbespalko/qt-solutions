...
Sbk_QtCheckBoxFactory_Init(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    // 0: QtCheckBoxFactory::QtCheckBoxFactory(QObject*)
    if (numArgs == 0) {
    ...
    Sbk_QtCheckBoxFactory_Init_TypeError:
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtCheckBoxFactory");
        return -1;
}

static PyObject* Sbk_QtCheckBoxFactoryFunc_connectPropertyManager(PyObject* self, PyObject* pyArg)
{
    QtCheckBoxFactoryWrapper* cppSelf = nullptr;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
        return {};
    cppSelf = static_cast<QtCheckBoxFactoryWrapper *>(reinterpret_cast< ::QtCheckBoxFactory *>(Shiboken::Conversions::cppPointer(SbkqtpropertybrowserTypes[SBK_QTCHECKBOXFACTORY_IDX], reinterpret_cast<SbkObject *>(self))));
    int overloadId = -1;
    PythonToCppFunc pythonToCpp{};
    SBK_UNUSED(pythonToCpp)

    // Overloaded function decisor
    // 0: QtCheckBoxFactory::connectPropertyManager(QtBoolPropertyManager*)
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            static_cast<::QtCheckBoxFactoryWrapper*>(cppSelf)->QtCheckBoxFactoryWrapper::connectPropertyManager_protected(cppArg0);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
        }
    }
    ...
    Sbk_QtCheckBoxFactoryFunc_connectPropertyManager_TypeError:
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtCheckBoxFactory.connectPropertyManager");
        return {};
}
...
static PyObject* Sbk_QtCheckBoxFactoryFunc_createAttributeEditor(PyObject* self, PyObject* args)
{
    ...
    // Overloaded function decisor
    // 0: QtCheckBoxFactory::createAttributeEditor(QtBoolPropertyManager*,QtProperty*,QWidget*,BrowserCol)
    if (numArgs == 4
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            QWidget * cppResult = static_cast<::QtCheckBoxFactoryWrapper*>(cppSelf)->QtCheckBoxFactoryWrapper::createAttributeEditor_protected(cppArg0, cppArg1, cppArg2, cppArg3);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
    ...
    Sbk_QtCheckBoxFactoryFunc_createAttributeEditor_TypeError:
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtCheckBoxFactory.createAttributeEditor");
        return {};
}
...
static PyObject* Sbk_QtCheckBoxFactoryFunc_createEditor(PyObject* self, PyObject* args)
{
    ...
    // Overloaded function decisor
    // 0: QtCheckBoxFactory::createEditor(QtBoolPropertyManager*,QtProperty*,QWidget*)
    if (numArgs == 3
        && (pythonToCpp[0] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTBOOLPROPERTYMANAGER_IDX]), (pyArgs[0])))
        && (pythonToCpp[1] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTPROPERTY_IDX]), (pyArgs[1])))
        && (pythonToCpp[2] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkPySide2_QtWidgetsTypes[SBK_QWIDGET_IDX]), (pyArgs[2])))) {
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            QWidget * cppResult = static_cast<::QtCheckBoxFactoryWrapper*>(cppSelf)->QtCheckBoxFactoryWrapper::createEditor_protected(cppArg0, cppArg1, cppArg2);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
            pyResult = Shiboken::Conversions::pointerToPython(reinterpret_cast<SbkObjectType *>(SbkPySide2_QtWidgetsTypes[SBK_QWIDGET_IDX]), cppResult);
            Shiboken::Object::setParent(self, pyResult);
        }
    ...
    Sbk_QtCheckBoxFactoryFunc_createEditor_TypeError:
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtCheckBoxFactory.createEditor");
        return {};
}
...
static PyObject* Sbk_QtCheckBoxFactoryFunc_disconnectPropertyManager(PyObject* self, PyObject* pyArg)
{
    ...
    // Overloaded function decisor
    // 0: QtCheckBoxFactory::disconnectPropertyManager(QtBoolPropertyManager*)
    if ((pythonToCpp = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTBOOLPROPERTYMANAGER_IDX]), (pyArg)))) {
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            static_cast<::QtCheckBoxFactoryWrapper*>(cppSelf)->QtCheckBoxFactoryWrapper::disconnectPropertyManager_protected(cppArg0);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
        }
    }
    ...
    Sbk_QtCheckBoxFactoryFunc_disconnectPropertyManager_TypeError:
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtCheckBoxFactory.disconnectPropertyManager");
        return {};
}

static PyMethodDef Sbk_QtCheckBoxFactory_methods[] = {
    {"connectPropertyManager", reinterpret_cast<PyCFunction>(Sbk_QtCheckBoxFactoryFunc_connectPropertyManager), METH_O},
    {"createAttributeEditor", reinterpret_cast<PyCFunction>(Sbk_QtCheckBoxFactoryFunc_createAttributeEditor), METH_VARARGS},
    {"createEditor", reinterpret_cast<PyCFunction>(Sbk_QtCheckBoxFactoryFunc_createEditor), METH_VARARGS},
    {"disconnectPropertyManager", reinterpret_cast<PyCFunction>(Sbk_QtCheckBoxFactoryFunc_disconnectPropertyManager), METH_O},
...
static PyType_Slot Sbk_QtCheckBoxFactory_slots[] = {
    ...
    {Py_tp_traverse,    reinterpret_cast<void*>(Sbk_QtCheckBoxFactory_traverse)},
    {Py_tp_clear,       reinterpret_cast<void*>(Sbk_QtCheckBoxFactory_clear)},
    {Py_tp_richcompare, nullptr},
    {Py_tp_iter,        nullptr},
    {Py_tp_iternext,    nullptr},
    {Py_tp_methods,     reinterpret_cast<void*>(Sbk_QtCheckBoxFactory_methods)},
    {Py_tp_getset,      nullptr},
    {Py_tp_init,        reinterpret_cast<void*>(Sbk_QtCheckBoxFactory_Init)},
...
static PythonToCppFunc is_QtCheckBoxFactory_PythonToCpp_QtCheckBoxFactory_PTR_Convertible(PyObject* pyIn) {
    ...
    if (PyObject_TypeCheck(pyIn, reinterpret_cast<PyTypeObject*>(Sbk_QtCheckBoxFactory_TypeF())))
...
static PyObject* QtCheckBoxFactory_PTR_CppToPython_QtCheckBoxFactory(const void* cppIn) {
    ...
    auto tCppIn = reinterpret_cast<const ::QtCheckBoxFactory *>(cppIn);
    ...
    PyObject *result = Shiboken::Object::newObject(Sbk_QtCheckBoxFactory_TypeF(), const_cast<void*>(cppIn), false, /* exactType */ changedTypeName, typeName);
    if (changedTypeName)
        delete [] typeName;
    return result;
}
