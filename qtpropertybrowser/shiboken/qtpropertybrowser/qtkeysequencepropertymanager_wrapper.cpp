...
bool QtKeySequencePropertyManagerWrapper::check(const QtProperty * property) const
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtKeySequencePropertyManager.check", "bool", Py_TYPE(pyResult)->tp_name);
        return false;
    }
    bool cppResult;
...
QIcon QtKeySequencePropertyManagerWrapper::checkIcon(const QtProperty * property) const
{
    ...
    if (pyOverride.isNull()) {
        gil.release();
        return this->::QtKeySequencePropertyManager::checkIcon(property);
    }
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtKeySequencePropertyManager.checkIcon", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QIcon >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return {};
    }
    ::QIcon cppResult;
    pythonToCpp(pyResult, &cppResult);
...
QtProperty * QtKeySequencePropertyManagerWrapper::createProperty()
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtKeySequencePropertyManager.createProperty", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QtProperty >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return nullptr;
    }
...
QString QtKeySequencePropertyManagerWrapper::displayText(const QtProperty * property) const
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtKeySequencePropertyManager.displayText", "QString", Py_TYPE(pyResult)->tp_name);
        return ::QString();
    }
    ::QString cppResult;
    pythonToCpp(pyResult, &cppResult);
...
QLineEdit::EchoMode QtKeySequencePropertyManagerWrapper::echoMode(const QtProperty * arg__1) const
{
    Shiboken::GilState gil;
    if (PyErr_Occurred())
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtKeySequencePropertyManager.echoMode", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QLineEdit::EchoMode >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return QLineEdit::Normal;
    }
...
bool QtKeySequencePropertyManagerWrapper::event(QEvent * event)
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(Shiboken::Conversions::PrimitiveTypeConverter<bool>(), pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtKeySequencePropertyManager.event", "bool", Py_TYPE(pyResult)->tp_name);
        return false;
    }
    bool cppResult;
    pythonToCpp(pyResult, &cppResult);
...
bool QtKeySequencePropertyManagerWrapper::eventFilter(QObject * watched, QEvent * event)
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(Shiboken::Conversions::PrimitiveTypeConverter<bool>(), pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtKeySequencePropertyManager.eventFilter", "bool", Py_TYPE(pyResult)->tp_name);
        return false;
    }
    bool cppResult;
    pythonToCpp(pyResult, &cppResult);
...
QBrush QtKeySequencePropertyManagerWrapper::foreground(const QtProperty * property) const
{
    ...
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtKeySequencePropertyManager.foreground", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QBrush >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return {};
    }
    ::QBrush cppResult;
    pythonToCpp(pyResult, &cppResult);
...
QString QtKeySequencePropertyManagerWrapper::formatText(const QtProperty * property) const
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtKeySequencePropertyManager.formatText", "QString", Py_TYPE(pyResult)->tp_name);
        return ::QString();
    }
    ::QString cppResult;
    pythonToCpp(pyResult, &cppResult);
...
bool QtKeySequencePropertyManagerWrapper::hasValue(const QtProperty * property) const
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(Shiboken::Conversions::PrimitiveTypeConverter<bool>(), pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtKeySequencePropertyManager.hasValue", "bool", Py_TYPE(pyResult)->tp_name);
        return false;
    }
    bool cppResult;
    pythonToCpp(pyResult, &cppResult);
...
void QtKeySequencePropertyManagerWrapper::initializeProperty(QtProperty * property)
{
    ...
    if (pyOverride.isNull()) {
        gil.release();
        this->::QtKeySequencePropertyManager::initializeProperty(property);
        return;
    }
...
bool QtKeySequencePropertyManagerWrapper::isReadOnly(const QtProperty * arg__1) const
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(Shiboken::Conversions::PrimitiveTypeConverter<bool>(), pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtKeySequencePropertyManager.isReadOnly", "bool", Py_TYPE(pyResult)->tp_name);
        return false;
    }
    bool cppResult;
    pythonToCpp(pyResult, &cppResult);
...
QString QtKeySequencePropertyManagerWrapper::maximumText(const QtProperty * property) const
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtKeySequencePropertyManager.maximumText", "QString", Py_TYPE(pyResult)->tp_name);
        return ::QString();
    }
    ::QString cppResult;
    pythonToCpp(pyResult, &cppResult);
...
QString QtKeySequencePropertyManagerWrapper::minimumText(const QtProperty * property) const
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtKeySequencePropertyManager.minimumText", "QString", Py_TYPE(pyResult)->tp_name);
        return ::QString();
    }
    ::QString cppResult;
    pythonToCpp(pyResult, &cppResult);
...
QString QtKeySequencePropertyManagerWrapper::pkAvgText(const QtProperty * property) const
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtKeySequencePropertyManager.pkAvgText", "QString", Py_TYPE(pyResult)->tp_name);
        return ::QString();
    }
    ::QString cppResult;
    pythonToCpp(pyResult, &cppResult);
...
void QtKeySequencePropertyManagerWrapper::uninitializeProperty(QtProperty * property)
{
    ...
    if (pyOverride.isNull()) {
        gil.release();
        this->::QtKeySequencePropertyManager::uninitializeProperty(property);
        return;
    }
...
QString QtKeySequencePropertyManagerWrapper::unitText(const QtProperty * property) const
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtKeySequencePropertyManager.unitText", "QString", Py_TYPE(pyResult)->tp_name);
        return ::QString();
    }
    ::QString cppResult;
    pythonToCpp(pyResult, &cppResult);
...
QIcon QtKeySequencePropertyManagerWrapper::valueIcon(const QtProperty * property) const
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppValueConvertible(reinterpret_cast<SbkObjectType *>(SbkPySide2_QtGuiTypes[SBK_QICON_IDX]), pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtKeySequencePropertyManager.valueIcon", reinterpret_cast<PyTypeObject *>(Shiboken::SbkType< QIcon >())->tp_name, Py_TYPE(pyResult)->tp_name);
        return {};
    }
    ::QIcon cppResult;
    pythonToCpp(pyResult, &cppResult);
...
QString QtKeySequencePropertyManagerWrapper::valueText(const QtProperty * property) const
{
    ...
    PythonToCppFunc pythonToCpp = Shiboken::Conversions::isPythonToCppConvertible(SbkPySide2_QtCoreTypeConverters[SBK_QSTRING_IDX], pyResult);
    if (!pythonToCpp) {
        Shiboken::warning(PyExc_RuntimeWarning, 2, "Invalid return value in function %s, expected %s, got %s.", "QtKeySequencePropertyManager.valueText", "QString", Py_TYPE(pyResult)->tp_name);
        return ::QString();
    }
    ::QString cppResult;
    pythonToCpp(pyResult, &cppResult);
...
Sbk_QtKeySequencePropertyManager_Init(PyObject* self, PyObject* args, PyObject* kwds)
{
    ...
    ::QtKeySequencePropertyManagerWrapper* cptr = 0;
    int overloadId = -1;
    ...
    // 0: QtKeySequencePropertyManager(QObject*)
    if (numArgs == 0) {
    ...
    // Call function/method
    {
        if (kwds) {
            ...
            if (value && pyArgs[0]) {
                PyErr_SetString(PyExc_TypeError, "qtpropertybrowser.QtKeySequencePropertyManager(): got multiple values for keyword argument 'parent'.");
                return -1;
            } else if (value) {
                pyArgs[0] = value;
    ...
    Sbk_QtKeySequencePropertyManager_Init_TypeError:
        ...
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtKeySequencePropertyManager", overloads);
        return -1;
}

static PyObject* Sbk_QtKeySequencePropertyManagerFunc_check(PyObject* self, PyObject* pyArg)
{
    QtKeySequencePropertyManagerWrapper* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
        return 0;
    cppSelf = (QtKeySequencePropertyManagerWrapper*)reinterpret_cast< ::QtKeySequencePropertyManager *>(Shiboken::Conversions::cppPointer(SbkqtpropertybrowserTypes[SBK_QTKEYSEQUENCEPROPERTYMANAGER_IDX], reinterpret_cast<SbkObject *>(self)));
    PyObject* pyResult = 0;
    int overloadId = -1;
    ...
    // Call function/method
    {
        ...
        if (!PyErr_Occurred()) {
            ...
            PyThreadState* _save = PyEval_SaveThread(); // Py_BEGIN_ALLOW_THREADS
            bool cppResult = Shiboken::Object::hasCppWrapper(reinterpret_cast<SbkObject*>(self)) ? const_cast<const ::QtKeySequencePropertyManagerWrapper*>(cppSelf)->::QtKeySequencePropertyManager::check(cppArg0) : const_cast<const ::QtKeySequencePropertyManagerWrapper*>(cppSelf)->check(cppArg0);
            PyEval_RestoreThread(_save); // Py_END_ALLOW_THREADS
    ...
    Sbk_QtKeySequencePropertyManagerFunc_check_TypeError:
        ...
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtKeySequencePropertyManager.check", overloads);
        return 0;
}

static PyObject* Sbk_QtKeySequencePropertyManagerFunc_checkIcon(PyObject* self, PyObject* pyArg)
{
    QtKeySequencePropertyManagerWrapper* cppSelf = 0;
    SBK_UNUSED(cppSelf)
    if (!Shiboken::Object::isValid(self))
    ...
    // Function signature not found.
    if (overloadId == -1) goto Sbk_QtKeySequencePropertyManagerFunc_checkIcon_TypeError;
    ...
    Sbk_QtKeySequencePropertyManagerFunc_checkIcon_TypeError:
        const char* overloads[] = {"qtpropertybrowser.QtProperty", 0};
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtKeySequencePropertyManager.checkIcon", overloads);
        return 0;
}
...
static PyObject* Sbk_QtKeySequencePropertyManagerFunc_initializeProperty(PyObject* self, PyObject* pyArg)
{
    ...
    Sbk_QtKeySequencePropertyManagerFunc_initializeProperty_TypeError:
        const char* overloads[] = {"qtpropertybrowser.QtProperty", 0};
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtKeySequencePropertyManager.initializeProperty", overloads);
        return 0;
}
...
static PyObject* Sbk_QtKeySequencePropertyManagerFunc_setCheck(PyObject* self, PyObject* args)
{
    ...
    Sbk_QtKeySequencePropertyManagerFunc_setCheck_TypeError:
        ...
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtKeySequencePropertyManager.setCheck", overloads);
        return 0;
}
...
static PyObject* Sbk_QtKeySequencePropertyManagerFunc_setValue(PyObject* self, PyObject* args)
{
    ...
    // Overloaded function decisor
    // 0: setValue(QtProperty*,QKeySequence)
    if (numArgs == 2
        && (pythonToCpp[0] = Shiboken::Conversions::isPythonToCppPointerConvertible(reinterpret_cast<SbkObjectType *>(SbkqtpropertybrowserTypes[SBK_QTPROPERTY_IDX]), (pyArgs[0])))
    ...
    Sbk_QtKeySequencePropertyManagerFunc_setValue_TypeError:
        const char* overloads[] = {"qtpropertybrowser.QtProperty, PySide2.QtGui.QKeySequence", 0};
        Shiboken::setErrorAboutWrongArguments(args, "qtpropertybrowser.QtKeySequencePropertyManager.setValue", overloads);
        return 0;
}
...
static PyObject* Sbk_QtKeySequencePropertyManagerFunc_uninitializeProperty(PyObject* self, PyObject* pyArg)
{
    ...
    Sbk_QtKeySequencePropertyManagerFunc_uninitializeProperty_TypeError:
        const char* overloads[] = {"qtpropertybrowser.QtProperty", 0};
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtKeySequencePropertyManager.uninitializeProperty", overloads);
        return 0;
}
...
static PyObject* Sbk_QtKeySequencePropertyManagerFunc_value(PyObject* self, PyObject* pyArg)
{
    ...
    Sbk_QtKeySequencePropertyManagerFunc_value_TypeError:
        const char* overloads[] = {"qtpropertybrowser.QtProperty", 0};
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtKeySequencePropertyManager.value", overloads);
        return 0;
}
...
static PyObject* Sbk_QtKeySequencePropertyManagerFunc_valueText(PyObject* self, PyObject* pyArg)
{
    ...
    Sbk_QtKeySequencePropertyManagerFunc_valueText_TypeError:
        const char* overloads[] = {"qtpropertybrowser.QtProperty", 0};
        Shiboken::setErrorAboutWrongArguments(pyArg, "qtpropertybrowser.QtKeySequencePropertyManager.valueText", overloads);
        return 0;
}
...
// Class Definition -----------------------------------------------
extern "C" {
static SbkObjectType *_Sbk_QtKeySequencePropertyManager_Type = nullptr;
static SbkObjectType *Sbk_QtKeySequencePropertyManager_TypeF(void)
{
...
static PyType_Slot Sbk_QtKeySequencePropertyManager_slots[] = {
    ...
    {Py_tp_traverse,    (void *)Sbk_QtKeySequencePropertyManager_traverse},
    {Py_tp_clear,       (void *)Sbk_QtKeySequencePropertyManager_clear},
    {Py_tp_richcompare, (void *)0},
    {Py_tp_iter,        (void *)0},
    {Py_tp_iternext,    (void *)0},
    {Py_tp_methods,     (void *)Sbk_QtKeySequencePropertyManager_methods},
    {Py_tp_getset,      (void *)0},
    {Py_tp_init,        (void *)Sbk_QtKeySequencePropertyManager_Init},
...
static void* Sbk_QtKeySequencePropertyManager_typeDiscovery(void* cptr, SbkObjectType* instanceType)
{
...
void init_QtKeySequencePropertyManager(PyObject* module)
{
    ...
    SbkqtpropertybrowserTypes[SBK_QTKEYSEQUENCEPROPERTYMANAGER_IDX]
        = reinterpret_cast<PyTypeObject*>(Sbk_QtKeySequencePropertyManager_TypeF());

    // Register Converter
    SbkConverter* converter = Shiboken::Conversions::createConverter(Sbk_QtKeySequencePropertyManager_TypeF(),
    ...
    PySide::Signal::registerSignals(Sbk_QtKeySequencePropertyManager_TypeF(), &::QtKeySequencePropertyManager::staticMetaObject);

    QtKeySequencePropertyManagerWrapper::pysideInitQtMetaTypes();
    Shiboken::ObjectType::setSubTypeInitHook(Sbk_QtKeySequencePropertyManager_TypeF(), &PySide::initQObjectSubType);
    PySide::initDynamicMetaObject(Sbk_QtKeySequencePropertyManager_TypeF(), &::QtKeySequencePropertyManager::staticMetaObject, sizeof(::QtKeySequencePropertyManager));
}
