...
{
public:
    QtTreePropertyBrowserWrapper(QWidget * parent = 0);
    ...
    inline QWidget * createAttributeEditor_protected(QtProperty * property, QWidget * parent, Attribute attribute) { return QtTreePropertyBrowser::createAttributeEditor(property, parent, Attribute(attribute)); }
